            ...
            <div className="h-screen w-full flex flex-col bg-black">
                <div className="h-4/5 w-full  flex">
                    ...
                    <div className="h-full w-1/2 py-5">
                        ...
                        <div className="w-full h-4/5">
                            <img src={signimage} alt="" className='h-full' />
                        </div>
                    </div>
                ...
                <div className="h-1/5  w-full flex justify-center items-center">
                    <div className="flex h-3/5 justify-center items-center gap-3">
                        ...
                        <div className="h-10 w-10 flex justify-center items-center"><i className="fa-solid fa-microphone fa-xl cursor-pointer" style={{ color: "#ffffff" }}></i></div>
